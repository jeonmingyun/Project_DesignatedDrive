...
public class MapSearchActivity extends AppCompatActivity implements View.OnClickListener, MapView.MapViewEventListener, MapView.CurrentLocationEventListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        address_search_text = findViewById(R.id.address_search_text);
